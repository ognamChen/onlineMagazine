            ...
            <div class="col-md-8">
                <div class="feature_mh">
                    <div class="feature_category">
                        ...
                        <div class="feature_readmore" onclick="javascript:location.href='<?php echo $category_url; ?>'">
                            <img class="img-fluid" width="150px;" src="<?php echo get_template_directory_uri() . "/assets/img/icon-readmore.png"; ?>" alt="">
                        </div>
